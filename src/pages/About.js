  ...
  return (
    <section className="section about-section">
      ...
      <p>
        ...
        bitters. Cocktails vary widely across regions of the world, and many
        websites publish both original recipes and their own interpretations of
        older and more famous cocktails
      </p>
    </section>
  )
}
